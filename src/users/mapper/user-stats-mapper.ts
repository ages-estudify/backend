...
export class UserStatsMapper {
    static toDto(questionStats: OverviewDto, level: LevelDto, starsStats, topics: CompletedTopicsDto, subject: AccuracyBySubjectDto[], lastAttempts: SimuladoDto[]): UserStatsDto {
        return {
            data: {
